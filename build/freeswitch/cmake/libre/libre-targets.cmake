...
set_target_properties(libre::re PROPERTIES
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include/re"
  INTERFACE_LINK_LIBRARIES "\$<LINK_ONLY:Threads::Threads>;\$<LINK_ONLY:resolv>;\$<LINK_ONLY:ZLIB::ZLIB>;\$<LINK_ONLY:OpenSSL::SSL>;\$<LINK_ONLY:OpenSSL::Crypto>;\$<LINK_ONLY:m>;\$<LINK_ONLY:dl>"
)
...
file(GLOB _cmake_config_files "${CMAKE_CURRENT_LIST_DIR}/libre-targets-*.cmake")
